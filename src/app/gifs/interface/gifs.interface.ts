...
export interface SeachGIFResponse {
    data:       Gif[];
...
export class Convert {
    public static toSeachGIFResponse(json: string): SeachGIFResponse {
        return cast(JSON.parse(json), r("SeachGIFResponse"));
    }

    public static seachGIFResponseToJson(value: SeachGIFResponse): string {
        return JSON.stringify(uncast(value, r("SeachGIFResponse")), null, 2);
    }
}
...
const typeMap: any = {
    ...
    "Datum": o([
        ...
        { json: "source_tld", js: "source_tld", typ: r("SourceTLD") },
